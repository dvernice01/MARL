...
All the environments are registered in the `quadcopter_hierarchical_control` extension. They start
...
def main():
    """Print all environments registered in `quadcopter_hierarchical_control` extension."""
