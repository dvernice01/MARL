...
def some_public_function(x: int):
    print("[quadcopter_hierarchical_control] some_public_function was called with x: ", x)
    return x**x
...
class ExampleExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[quadcopter_hierarchical_control] startup")
    ...
    def on_shutdown(self):
        print("[quadcopter_hierarchical_control] shutdown")