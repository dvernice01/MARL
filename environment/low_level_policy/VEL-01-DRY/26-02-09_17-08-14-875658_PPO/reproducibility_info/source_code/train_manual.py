...
import velocity_controller.tasks.direct.velocity_controller  # noqa: F401
...
def save_reproducibility_info(log_dir, agent, args_cli, env_cfg):
    ...
    files_to_copy = [
        ...
        # Env
        os.path.abspath(os.path.join(os.path.dirname(__file__), "../../source/velocity_controller/velocity_controller/tasks/direct/velocity_controller/velocity_controller_env.py")),
        os.path.abspath(os.path.join(os.path.dirname(__file__), "../../source/velocity_controller/velocity_controller/tasks/direct/velocity_controller/velocity_controller_env_cfg.py")),
    ]
    
    # Add Agent Config File
    if args_cli.agent == "ppo":
         files_to_copy.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "configs", "agents", "ppo_agent.py"))
...
def main(env_cfg, agent_cfg: dict):
    ...
    log_dir = os.path.join("projects", "velocity_controller", "logs", "skrl", "velocity_controller_direct", experiment_name)
    ...
    if args_cli.agent == "ppo":
        from configs.agents.ppo_agent import get_ppo_agent
    ...
    agent_config = agent.cfg
    default_timesteps = 100000 # ~25M steps
