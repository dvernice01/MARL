...
from .velocity_controller_env_cfg import VelocityControllerEnvCfg


class VelocityControllerEnv(DirectRLEnv):
    cfg: VelocityControllerEnvCfg

    def __init__(self, cfg: VelocityControllerEnvCfg, render_mode: str | None = None, **kwargs):
