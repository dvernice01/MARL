...
All the environments are registered in the `QuadcopterVae` extension. They start
...
import QuadcopterVae.tasks  # noqa: F401


def main():
    """Print all environments registered in `QuadcopterVae` extension."""
