...
All the environments are registered in the `quadcopter_rnn` extension. They start
...
import quadcopter_rnn.tasks  # noqa: F401


def main():
    """Print all environments registered in `quadcopter_rnn` extension."""
