...
All the environments are registered in the `quadcopter_vel_control` extension. They start
...
def main():
    """Print all environments registered in `quadcopter_vel_control` extension."""
